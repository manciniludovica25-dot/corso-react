...
function inviaOrdine() {
    ...
    const piattiSelezionati = Array.from(document.querySelectorAll('input[name="piatti"]:checked')).map(cb => cb.value);
    // Validazione piatti
...
function inizializzaMenu() {
    const container = document.getElementById("menuPiatti");
    const categorie = ['primo', 'secondo', 'contorno', 'dessert'];
